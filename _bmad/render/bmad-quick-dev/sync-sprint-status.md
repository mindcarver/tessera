...
- `story_key` is unset
- `/Users/carver/workspace/mindcarver/tessera/_bmad-output/implementation-artifacts/sprint-status.yaml` does not exist on disk

## Instructions

1. Load the FULL `/Users/carver/workspace/mindcarver/tessera/_bmad-output/implementation-artifacts/sprint-status.yaml` file.
